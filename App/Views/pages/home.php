...
<section>
  <div class="planning-toolbar" id="planning-toolbar">
    ...
    <a id="btnPlanningPdf" class="btn btn--pdf-link pdf-icon-btn" href="/print/planning?scope=all&amp;autoprint=1" target="_blank" rel="noopener" title="Експорт у PDF" aria-label="Експорт у PDF">
